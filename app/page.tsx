              ...
              <div className="space-y-4">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400">office.edc@rajalakshmi.edu.in</p>
                  </div>
                </div>
                <div className="flex items-start gap-4">
                  <div className="w-6 h-6 mt-1 text-red-600">📱</div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
            ...
            <div>
              ...
              <div className="flex gap-4 mb-4">
                <Link
                  href="https://www.facebook.com/ecellrec/"
                  target="_blank"
                ...
                <Link
                  href="https://www.instagram.com/eidc_rec/"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-10 h-10 flex items-center justify-center bg-zinc-800 rounded-full hover:bg-red-600 transition-colors"
                >
                ...
                <Link
                  href="https://www.linkedin.com/company/e-cell-rec/?originalSubdomain=in"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-10 h-10 flex items-center justify-center bg-zinc-800 rounded-full hover:bg-red-600 transition-colors"
                >
